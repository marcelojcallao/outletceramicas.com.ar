<div class="tt-desktop-header" >
    <div class="container" >
        <div class="tt-header-holder">
            <div class="tt-col-obj tt-obj-logo" style="margin-top: .7rem;">
                <!-- logo -->
                <a class="" href="/tienda" >
                    <img src="/images/logos/logo.png" alt="" style="width: 5rem;">
                </a>
                <!-- /logo -->
                <p>Perfiles, Chapas, Corralón de Materiales - Venta por Mayor y Menor.</p>
            </div>
            ...
            <div class="tt-col-obj tt-obj-options obj-move-right">
                ...
                <div class="tt-desctop-parent-search tt-parent-box">
                    <div class="tt-search tt-dropdown-obj">
                        <button class="tt-dropdown-toggle" data-tooltip="Buscar productos" data-tposition="bottom">
                            <i class="icon-f-85"></i>
                        </button>
