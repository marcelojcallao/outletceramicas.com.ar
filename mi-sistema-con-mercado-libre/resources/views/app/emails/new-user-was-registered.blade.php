                      ...
                      <tbody>
                        <tr>
                          <td align="center" valign="middle" width="100%" style="background: linear-gradient(to right, #ff7a59 0%, #ff8f59 100%); width: 100%; padding: 20px; min-width:100%; color: #ffffff">
                            <!-- <img src="https://static.hsappstatic.net/EmailNotificationSharedAssets/ex/hubspot-logo-white.png" alt="PiamondSA" width="120" height="35" style="width: 120px; height: 35px; vertical-align: middle; clear: both; width: auto; max-width: 100%;"> -->
                            <h2>PiamondSA</h2>
                      ...
                      <tbody>
                        <tr>
                          <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" valign="middle" style="padding: 0; ">
                                    ...
                                    <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">Un Usuario nuevo ha sido registrado</h1>
                            ...
                            <p style="margin: 0"><span><strong><h3>{{$admin_user->name()}}.</h3></strong></span>Se ha registrado el Usuario <strong>{{$new_user->name()}}</strong>.</p><br>
                            <p style="margin: 0">Este email es un recordatorio para asignarle un rol a este nuevo usuario.</p>
                                ...
                                <tr>
                                  <td align="center">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                      <tbody>
                                        <tr>
                                          <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="#" target="_blank" style="border: 1px solid #425b76; border-radius: 3px; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 500; line-height: 1; padding: 12px 20px; text-decoration: none; width: auto; min-width: 170px; white-space: nowrap; ">Ir al Sistema</a></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                            ...
                            <div itemscope itemtype="http://schema.org/EmailMessage">
                              <div itemprop="potentialAction" itemscope itemtype="http://schema.org/ViewAction">
                                <link itemprop="target" href="https//:www.piamond.sytes.net/login">
                            ...
                            <!-- <p style="font-size: 14px; margin: 0">Didn’t sign up for a new HubSpot account? <a href="https://help.hubspot.com/?utm_source=hs_email&amp;utm_medium=email&amp;utm_content=16807867" target="_blank" style="text-decoration: none; color: #00a4bd;">Let us know.</a></p> -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 0; height: 50px; width: 100%; min-width: 100%; line-height: 0;">
                              <tbody>
                                <tr>
                                  <td height="50"><span style="-webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; color: transparent; background: none; user-select: none; -moz-user-select: none; -ms-user-select:none; -webkit-user-select:none; text-overflow: ellipsis; opacity: 0; width:100%; min-width: 100%; height:1; overlfow:hidden; margin: -1px 0 0 0; padding:0; font-size: 0;"> &nbsp;</span></td>
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" valign="middle" style="padding: 20px 0 65px; "><a href=""></a><span>&nbsp;</span>
                                    <p style="font-size: 12px; color: #516f90">PiamondSA.<!-- <br>25 First Street, 2nd Floor<br>Cambridge, MA 02141</p> -->
                                  </td>
                                </tr>
                              </tbody>
                            </table>
