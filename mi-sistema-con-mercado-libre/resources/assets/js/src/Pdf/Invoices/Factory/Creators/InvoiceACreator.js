...
import InvoiceA from "../Concrete/InvoiceA";

class InvoiceACreator {
    ...
    setPdfData(data)
    {
        console.log("🚀 ~ file: InvoiceACreator.js ~ line 16 ~ InvoiceACreator ~ data", data)
...
export default InvoiceACreator;
