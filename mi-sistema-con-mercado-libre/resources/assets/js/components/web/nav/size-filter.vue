<template>
    <li >
        <a v-tooltip.top-left="msg" @click.prevent="deleteSizeFilter" href="#">{{filter.value_name}}</a>
    </li>
</template>
...
export default {
		...
		methods : {
				...
				deleteSizeFilter(){
					...
					this.$store.commit('DELETE_SIZE_FILTER', this.filter);
					
                    this.$store.commit('SHOW_SIZE', this.filter.id);
