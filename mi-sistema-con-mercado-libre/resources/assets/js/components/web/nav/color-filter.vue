<template>
    <li >
        <a v-tooltip.top-left="msg" @click.prevent="deleteColorFilter" href="#">{{filter.value_name}}</a>
    </li>
</template>
...
export default {
		...
		methods : {
				...
				deleteColorFilter(){
					...
					this.$store.commit('DELETE_COLOR_FILTER', this.filter);
					
                    this.$store.commit('SHOW_COLOR', this.filter.id);
