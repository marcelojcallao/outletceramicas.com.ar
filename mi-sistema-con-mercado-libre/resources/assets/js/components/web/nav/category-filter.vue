<template>
		<li >
			<a v-tooltip.top-left="msg" @click.prevent="deleteCategoryFilter" href="#">{{filter.parent_name}}</a>
		</li>
</template>
...
export default {
		...
		methods : {
				...
				deleteCategoryFilter(){
					...
					this.$store.commit('DELETE_CATEGORY_FILTER', this.filter);
					
                    this.$store.commit('SHOW_CATEGORY', this.filter.id);
