    ...
    <div class="wrapper-invoice-list-table">
        ...
        <div class="row">
            <form class="form flex " >
                <div class="form-group col-md-3 pd-t-10" style="padding-bottom-15px;">
    ...
    export default {
        ...
        methods : {
            ...
            async loadData(page=1)
            {
                ...
                const from = this.$moment(this.date_from).format('YYYY-MM-DD');

                const to = this.$moment(this.date_to).format('YYYY-MM-DD');

                let url = `/api/sale_invoice/index?page=${page}&from=${from}&to=${to}`;
            ...
            async excel(){
                ...
                let url = `/api/sale_invoice/excel?from=${from}&to=${to}`;
