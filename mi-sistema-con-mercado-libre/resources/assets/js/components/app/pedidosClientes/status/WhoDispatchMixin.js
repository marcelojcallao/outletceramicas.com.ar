...
export default {
    ...
    methods : {
        ...
        dropdown_open()
        {
            let open = ! this.OpenWhoDispatchInputGetter;
            
            this.$store.commit('SET_OPEN_WHO_DISPATCH_INPUT', open);
        },
    ...
    computed : {
        ...
        ...mapGetters([
            ...
            'WhoDispatchSpinnerGetter',
            'OpenWhoDispatchInputGetter',
            'PedidoListChildRowReactivityData',
        ]),

        who : {
            get(){
                return this.WhoDispatchGetter;
            },
            set(value){
                this.$store.commit('SET_WHO_DISPATCH', value);
            }
        },

        OpenWhoInputGetter(){
            return this.OpenWhoDispatchInputGetter;
        },

        WhoSpinnerGetter(){
            return this.WhoDispatchSpinnerGetter;
        },
