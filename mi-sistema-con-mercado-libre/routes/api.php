...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::group(['prefix' => 'price_list'], function () {
		...
		Route::post('update_name', 'Api\PriceListsController@update_name');
		Route::post('enable', 'Api\PriceListsController@enable');
	});
	...
	Route::group(['prefix' => 'cash'], function () {
		Route::get('search', 'Api\CashController@search');
		...
		Route::post('update', 'Api\CashController@update');
	});
