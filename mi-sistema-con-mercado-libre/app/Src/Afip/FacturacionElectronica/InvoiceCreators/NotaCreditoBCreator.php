...
use App\Src\Afip\FacturacionElectronica\InvoiceProducts\NotaCreditoB;
use App\Src\Afip\FacturacionElectronica\InvoiceCreators\NotaCreditoInterface;


class NotaCreditoBCreator extends Creators implements NotaCreditoInterface
{
    public function factoryInvoice($environment): Invoice {
        return new NotaCreditoB($environment);
    }

    public function generate_nota_credito($environment, $nota_credito_data)
    {
        //dd($nota_credito_data);
