...
class SaleInvoiceController extends Controller
{
    ...
    public function search($request)
    {
        ...
        $invoices = $invoices->whereBetween('cbte_fch', [$request->from, $request->to]);
    ...
    public function excel()
    {
        ...
        $from = Date::createFromFormat( 'Y-m-d', request()->from )->format('Y-m-d');

        $to = Date::createFromFormat( 'Y-m-d', request()->to )->format('Y-m-d');
